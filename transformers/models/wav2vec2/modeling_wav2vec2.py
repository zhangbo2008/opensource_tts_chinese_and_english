...
#========训练时候的数据提升.
        ...
        encoder_outputs = self.encoder( # 应该写解码才对, 用
            hidden_states,
            attention_mask=attention_mask,
...
class Wav2Vec2ForCTC(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            log_probs = F.log_softmax(logits, dim=-1).transpose(0, 1) #用log_softmax来计算概率. 就是在softmax之后再来一个log运算.
            ...
            with torch.backends.cudnn.flags(enabled=False):
                loss = F.ctc_loss(         # 语音的学习一定要用ctc!!!!!!!!!!
                    ...
                    blank=self.config.pad_token_id,  # padding 的编码
