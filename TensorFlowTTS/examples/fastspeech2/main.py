...
def main():
    ...
    parser.add_argument(
        "--config", type=str, required=False, help="yaml format configuration file."
    )
    parser.add_argument(
        "--resume",
        default="",
    ...
    dir3='E:/sound/LibriSpeech/dev-clean'
    args = parser.parse_args()
    args.train_dir=dir3
    args.dev_dir=dir3
    args.outdir='E:/sound_out'
    args.config='conf/fastspeech2.v1.yaml'
